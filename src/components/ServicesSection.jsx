    ...
    <div className="grid md:grid-cols-3 gap-10 mx-5 md:mx-20 my-16">
      {services.map((data, i) => (
        ...
        >
          ...
          {/* Title (before hover - only for md and above) */}
          <div className="hidden md:flex absolute inset-0 items-center justify-center transition-opacity duration-300 group-hover:opacity-0 z-10">
          ...
          {/* Content */}
          <div className="absolute inset-0 flex flex-col justify-center px-6 z-10 md:opacity-0 md:group-hover:opacity-100">
